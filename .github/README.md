...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vDYqs3V9N2L+ln0DX+LXelCKpodMXuWzgcUOOj1wzFg0cxojH0nO2DYquXVicErP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.970.0/index.min.mjs": "sha384-vDYqs3V9N2L+ln0DX+LXelCKpodMXuWzgcUOOj1wzFg0cxojH0nO2DYquXVicErP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.970.0/LICENSE
```
