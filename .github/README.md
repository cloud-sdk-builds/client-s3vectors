...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-19XxxoR0lG0yS0RQLtL+NgBCWXX/jmET42YD2hm1WkOELhoQva/BahWblxxa3en5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.906.0/index.min.mjs": "sha384-19XxxoR0lG0yS0RQLtL+NgBCWXX/jmET42YD2hm1WkOELhoQva/BahWblxxa3en5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.906.0/LICENSE
```
