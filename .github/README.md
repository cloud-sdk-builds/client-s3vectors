...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.1076.0).
...
- @aws-sdk/client-s3vectors v3.1076.0 - [https://cloud-sdk-builds.github.io/?sdk=client-s3vectors&version=3.1076.0](https://cloud-sdk-builds.github.io/?sdk=client-s3vectors&version=3.1076.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.1076.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZtvqD2+PqUlJzk7AfBk6qH0qBMHJfXEcDgulwyAstX+RCbhbbgPFzszliIiGh6Sa
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.1076.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.1076.0/index.min.mjs": "sha384-ZtvqD2+PqUlJzk7AfBk6qH0qBMHJfXEcDgulwyAstX+RCbhbbgPFzszliIiGh6Sa"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.1076.0/LICENSE
```
