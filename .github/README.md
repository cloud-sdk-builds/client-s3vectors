...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hmzBdXdZmnQ3u4W4LudBip0MYq0C6ENUS1zF21JA8XfdCvem1IR5QY3Q/wuTTHz+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.855.0/index.min.mjs": "sha384-hmzBdXdZmnQ3u4W4LudBip0MYq0C6ENUS1zF21JA8XfdCvem1IR5QY3Q/wuTTHz+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.855.0/LICENSE
```
