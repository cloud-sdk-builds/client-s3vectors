...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.1090.0).
...
- @aws-sdk/client-s3vectors - [https://cloud-sdk-builds.github.io/?sdk=client-s3vectors](https://cloud-sdk-builds.github.io/?sdk=client-s3vectors)
- @aws-sdk/client-s3vectors v3.1090.0 - [https://cloud-sdk-builds.github.io/?sdk=client-s3vectors&version=3.1090.0](https://cloud-sdk-builds.github.io/?sdk=client-s3vectors&version=3.1090.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.1090.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oAURhpn7oJqk1yTJuGDZm8+IZmEdKFUzxst0SHvnnkfqM/u9qLZvU7tYNFfEyi/u
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.1090.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.1090.0/index.min.mjs": "sha384-oAURhpn7oJqk1yTJuGDZm8+IZmEdKFUzxst0SHvnnkfqM/u9qLZvU7tYNFfEyi/u"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-s3vectors";
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.1090.0/LICENSE
```
