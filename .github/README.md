...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j2tGRIrBTShR9WQsIw8mFF0ls4GuiWGJI+eYne881e7XED7EezNZV409pu5Jftde
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.954.0/index.min.mjs": "sha384-j2tGRIrBTShR9WQsIw8mFF0ls4GuiWGJI+eYne881e7XED7EezNZV409pu5Jftde"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.954.0/LICENSE
```
