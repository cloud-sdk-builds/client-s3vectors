...
[`@aws-sdk/client-s3vectors`](https://www.npmjs.com/package/@aws-sdk/client-s3vectors/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1yE5f/N90zIOgLtd74dbAWILuadiVvDXDBWAHyeK6PbWD0P5mnspSxZgDkCK6zd9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-s3vectors": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-s3vectors@3.919.0/index.min.mjs": "sha384-1yE5f/N90zIOgLtd74dbAWILuadiVvDXDBWAHyeK6PbWD0P5mnspSxZgDkCK6zd9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-s3vectors/blob/refs/tags/3.919.0/LICENSE
```
